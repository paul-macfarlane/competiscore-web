...
export function DeleteEventSection({
  ...
  const canDelete = confirmText === eventName;
  ...
  return (
    <div className="border-destructive/50 rounded-lg border bg-card text-card-foreground p-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h3 className="text-destructive font-semibold">Delete Event</h3>
          <p className="text-muted-foreground mt-1 text-sm">
            Permanently delete this event and all its data. This action cannot
            be undone.
          </p>
        </div>
        <Dialog
        ...
        >
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This will permanently delete the event, all members, match
                history, and data. This action cannot be undone.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-2 py-4">
              <Label htmlFor="confirm">
                Type <span className="font-semibold">{eventName}</span> to
                confirm
              </Label>
              <Input
                id="confirm"
