...
type AddPlaceholderToTeamFormProps = {
  teamId: string;
  availablePlaceholders: PlaceholderMember[];
};

export function AddPlaceholderToTeamForm({
  teamId,
  availablePlaceholders,
}: AddPlaceholderToTeamFormProps) {
  ...
  if (availablePlaceholders.length === 0) {
    return (
      <div className="text-center py-4 text-muted-foreground">
        <p className="text-sm">
          No available placeholder members to add. All league placeholder
